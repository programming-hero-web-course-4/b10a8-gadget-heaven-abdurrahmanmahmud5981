    ...
    <div>
      <div className=" text-white  bg-primary  py-14">
        <SubHeading
          ...
          subTitle="Explore our carefully selected range of products."
        />
      </div>
      <section className="  ">
        <div className="bg-purple-600 py-5 my-12 mx-auto  max-w-7xl mockup-window border-base-300 border">
            <div className="bg-purple-50 border-base-300 flex justify-center border-t px-4 py-16">
          <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
            <div className="relative group border p-3 bg-white rounded-md">
